...
from RLAlgorithms.agents.DQN_agents.DDQN_With_Prioritised_Experience_Replay import DDQN_With_Prioritised_Experience_Replay
...
config.file_to_save_data_results = "e:/Github/Deep-Reinforcement-Learning-Algorithms-with-PyTorch/results/data_and_graphs/Cart_Pole_Results_Data.pkl"
config.file_to_save_results_graph = "e:/Github/Deep-Reinforcement-Learning-Algorithms-with-PyTorch/results/data_and_graphs/Cart_Pole_Results_Graph.png"
...
if __name__ == "__main__":
    #AGENTS = [SAC_Discrete, DDQN, Dueling_DDQN, DQN, DQN_With_Fixed_Q_Targets, DDQN_With_Prioritised_Experience_Replay, A2C, PPO, A3C ]
    AGENTS = [SAC_Discrete]
