...
from RLAlgorithms.environments.ant_environments.ant_maze_env import AntMazeEnv
from RLAlgorithms.environments.ant_environments.point_maze_env import PointMazeEnv
