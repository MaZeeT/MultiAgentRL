...
class Agent:
    ...
    def run_episode(self, state):
        ...
        with tf.GradientTape() as tape:
            ...
            expected_reward = self.cal_expected_reward()
            # Normalize
            norm_expected_reward = self.normalize(expected_reward)
            # Calculating loss values to update our network
            self.cal_loss_values(norm_expected_reward)
            # Backpropagation
            self.backpropagation(tape)
